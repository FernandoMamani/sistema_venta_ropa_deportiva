...
export class ListProductComponent implements OnInit {
  ...
  dropdownListSize = [
    { item_id: 21, item_text: 'Talla 21' },
    { item_id: 32, item_text: 'Talla 32' },
    { item_id: 36, item_text: 'Talla 36' },
    { item_id: 37, item_text: 'Talla 37' },
    { item_id: 38, item_text: 'Talla 38' },
    { item_id: 39, item_text: 'Talla 39' },
    { item_id: 40, item_text: 'Talla 40' },
    { item_id: 41, item_text: 'Talla 41' },
  ];

  dropdownListSex = [
    { item_id: 'male', item_text: 'Hombre' },
    { item_id: 'female', item_text: 'Mujer' },
    { item_id: 'boy', item_text: 'Niño' },
  ];
